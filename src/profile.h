...
//
//    $Id: profile.h,v 1.1 2014/03/27 16:25:24 cvs Exp $
//
 ...
 * @author Fred Gleason <fredg@salemradiolabs.com>
 * 
...
class Profile
{
  ...
  **/
  ...
  QTime timeValue(QString section,QString tag,QTime default_value,
		  bool *ok=0) const;
